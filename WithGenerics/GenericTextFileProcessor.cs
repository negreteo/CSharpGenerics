...
namespace CSharpGenerics.WithGenerics {
  public class GenericTextFileProcessor {
    ...
    public static List<T> LoadFromTextFile<T> (string filePath) where T : class, new () {
      ...
      // New instance of type T, requires the new() limitation in where function declaration
      T entry = new T ();

      // Reflection, allows to look at an object at runtime and get the properties
      // Reflection is very expensive, do not use it everytime
      // GetType() used to identify whether is a log or a person object
